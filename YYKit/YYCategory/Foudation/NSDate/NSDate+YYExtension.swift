...
// MARK: - to String
extension NSDate {
    public func stringFromFormatDefault() -> String {
    ...
    public func stringFromFormat(format: String?, timeZone: NSTimeZone?) -> String {
        return self.stringFromFormat(format, timeZone: timeZone, locale: nil)
    }
    
    public func stringFromFormat(format: String?, timeZone: NSTimeZone?, locale: NSLocale?) -> String {
