...
// MARK: - 显示配置
public struct YYHudOpitions: OptionSetType {
...
extension YYHud {
    /**
     ...
     - returns: YYHud
     */
    public static func showLoading(inView superView: UIView? = nil, text: String? = nil, options: YYHudOpitions? = [.Modal]) -> YYHud {
        let finalOption = options ?? []
        return sharedInstance.showLoading(inView: superView, text: text, options: finalOption)
    }
    public static func showSuccess(inView superView: UIView? = nil, text: String? = nil) -> YYHud {
        return sharedInstance.showSuccess(inView: superView, text: text)
    }
    public static func showError(inView superView: UIView? = nil, text: String? = nil) -> YYHud {
        return sharedInstance.showError(inView: superView, text: text)
    }
    public static func showInfo(inView superView: UIView? = nil, text: String? = nil) -> YYHud {
        return sharedInstance.showInfo(inView: superView, text: text)
    }
    public static func showTip(inView superView: UIView? = nil, text: String) -> YYHud {
...
public class YYHud: UIView {
    ...
    public static let sharedInstance = YYHud.newInstanceFromXib()
    public static func newInstanceFromXib() -> YYHud {
        let view = NSBundle(forClass: self).loadNibNamed(self.classNameString, owner: nil, options: nil).first as? YYHud
        return view!
    }
